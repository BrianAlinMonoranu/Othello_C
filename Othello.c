...
void starting_positions( )//This function initializes the board will starter positions for B and W
{
    ...
    Game.board[4][4] = WHITE;//Setting this position to WHITE
    Game.board[5][5] = WHITE;//Setting this position to WHITE
    Game.board[4][5] = BLACK;//Setting this position to BLACK
    Game.board[5][4] = BLACK;//Setting this position ot BLACK
